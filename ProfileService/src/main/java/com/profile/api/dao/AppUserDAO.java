...
import com.profile.api.utils.EncrytedPasswordUtil;
...
public class AppUserDAO {
	...
	// Auto create App User Account.
	    public AppUser createAppUser(Connection<?> connection) {
	        ...
	        String encrytedPassword = EncrytedPasswordUtil.encrytePassword(randomPassword);
	        appUser = new AppUser();
	    ...
	    public AppUser registerNewUserAccount(AppUserForm appUserForm, List<String> roleNames) {
	        ...
	        appUser.setEnabled(true);
	        String encrytedPassword = EncrytedPasswordUtil.encrytePassword(appUserForm.getPassword());
	        appUser.setEncrytedPassword("{bcrypt}"+encrytedPassword);
	        this.entityManager.persist(appUser);
